    ...
    rows = [
        {
            ...
            "Quantity": "204", "Executed Price": "34.81", "Net Amount": "7101.24",
        },
        {
            "Trade Date": "1/25/2024", "Order Type": "Buy", "Security": "VOO",
            "Quantity": "10", "Executed Price": "400.00", "Net Amount": "4000.00",
        },
    ]
    ...
    rows = [
        {
            ...
            "Quantity": "14", "Executed Price": "76.2201", "Net Amount": "1067.08",
        },
    ]
    result = parse_etrade_rows(rows)
...
def test_parse_rows_chronological_order():
    ...
    rows = [
        {
            "Trade Date": "12/23/2025", "Order Type": "Sell", "Security": "FBTC",
            "Quantity": "14", "Executed Price": "76.00", "Net Amount": "1064.00",
        },
        {
            "Trade Date": "1/25/2024", "Order Type": "Buy", "Security": "FBTC",
            "Quantity": "204", "Executed Price": "34.81", "Net Amount": "7101.24",
