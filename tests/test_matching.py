"""Tests for sell-to-lot matching logic."""
...
def test_unique_match():
    """Single lot with enough shares is matched."""
...
def test_ambiguous_match():
    """Multiple lots with enough shares raises ValueError."""
...
def test_no_match():
    """No lot with enough shares raises ValueError."""
